...
final class TablesDBTest extends TestCase {
    ...
    public function testMethodListUsage(): void {
        ...
        $response = $this->tablesDB->listUsage(
        );
    ...
    public function testMethodListTableLogs(): void {
        ...
        $response = $this->tablesDB->listTableLogs(
            "<DATABASE_ID>",
            "<TABLE_ID>"
        );
    ...
    public function testMethodListRowLogs(): void {
        ...
        $response = $this->tablesDB->listRowLogs(
            "<DATABASE_ID>",
            "<TABLE_ID>",
            "<ROW_ID>"
        );
    ...
    public function testMethodGetTableUsage(): void {
        ...
        $response = $this->tablesDB->getTableUsage(
            "<DATABASE_ID>",
            "<TABLE_ID>"
        );
    ...
    public function testMethodGetUsage(): void {
        ...
        $response = $this->tablesDB->getUsage(
            "<DATABASE_ID>"
        );
