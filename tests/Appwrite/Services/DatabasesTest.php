...
final class DatabasesTest extends TestCase {
    ...
    public function testMethodListUsage(): void {
        ...
        $response = $this->databases->listUsage(
        );
    ...
    public function testMethodListDocumentLogs(): void {
        ...
        $response = $this->databases->listDocumentLogs(
            "<DATABASE_ID>",
            "<COLLECTION_ID>",
            "<DOCUMENT_ID>"
        );
    ...
    public function testMethodListCollectionLogs(): void {
        ...
        $response = $this->databases->listCollectionLogs(
            "<DATABASE_ID>",
            "<COLLECTION_ID>"
        );
    ...
    public function testMethodGetCollectionUsage(): void {
        ...
        $response = $this->databases->getCollectionUsage(
            "<DATABASE_ID>",
            "<COLLECTION_ID>"
        );
    ...
    public function testMethodListLogs(): void {
        ...
        $response = $this->databases->listLogs(
            "<DATABASE_ID>"
        );
    ...
    public function testMethodGetUsage(): void {
        ...
        $response = $this->databases->getUsage(
            "<DATABASE_ID>"
        );
