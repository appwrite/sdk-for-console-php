...
class TablesDB extends Service
{
     ...
     * @return array
     */
    public function listTableLogs(string $databaseId, string $tableId, ?array $queries = null): array
    {
        $apiPath = str_replace(
            ['{databaseId}', '{tableId}'],
            [$databaseId, $tableId],
     ...
     * @return array
     */
    public function listRowLogs(string $databaseId, string $tableId, string $rowId, ?array $queries = null): array
    {
        $apiPath = str_replace(
            ['{databaseId}', '{tableId}', '{rowId}'],
            [$databaseId, $tableId, $rowId],
     ...
     * @return array
     */
    public function getTableUsage(string $databaseId, string $tableId, ?UsageRange $range = null): array
    {
        $apiPath = str_replace(
            ['{databaseId}', '{tableId}'],
            [$databaseId, $tableId],
