...
class Functions extends Service
{
     ...
     * @return array
     */
    public function listTemplates(?array $runtimes = null, ?array $useCases = null, ?int $limit = null, ?int $offset = null, ?bool $total = null): array
    {
        $apiPath = str_replace(
            [],
            [],
     ...
     * @return array
     */
    public function getUsage(string $functionId, ?UsageRange $range = null): array
    {
        $apiPath = str_replace(
            ['{functionId}'],
            [$functionId],
