...
class Databases extends Service
{
     ...
     *
     * @param ?UsageRange $range
     * @throws AppwriteException
     * @return array
     *
     * @deprecated This API has been deprecated since 1.8.0. Please use `listUsage` instead.
     * @see TablesDB::listUsage
     */
    public function listUsage(?UsageRange $range = null): array
    {
        $apiPath = str_replace(
            [],
            [],
     ...
     * @return array
     *
     * @deprecated This API has been deprecated since 1.8.0. Please use `listRowLogs` instead.
     * @see TablesDB::listRowLogs
     */
    public function listDocumentLogs(string $databaseId, string $collectionId, string $documentId, ?array $queries = null): array
    {
        $apiPath = str_replace(
            ['{databaseId}', '{collectionId}', '{documentId}'],
            [$databaseId, $collectionId, $documentId],
     ...
     * @return array
     *
     * @deprecated This API has been deprecated since 1.8.0. Please use `listTableLogs` instead.
     * @see TablesDB::listTableLogs
     */
    public function listCollectionLogs(string $databaseId, string $collectionId, ?array $queries = null): array
    {
        $apiPath = str_replace(
            ['{databaseId}', '{collectionId}'],
            [$databaseId, $collectionId],
     ...
     * @return array
     *
     * @deprecated This API has been deprecated since 1.8.0. Please use `getTableUsage` instead.
     * @see TablesDB::getTableUsage
     */
    public function getCollectionUsage(string $databaseId, string $collectionId, ?UsageRange $range = null): array
    {
        $apiPath = str_replace(
            ['{databaseId}', '{collectionId}'],
            [$databaseId, $collectionId],
     ...
     * @return array
     *
     * @deprecated This API has been deprecated since 1.8.0. Please use `listDatabaseLogs` instead.
     * @see TablesDB::listDatabaseLogs
     */
    public function listLogs(string $databaseId, ?array $queries = null): array
    {
        $apiPath = str_replace(
            ['{databaseId}'],
            [$databaseId],
     ...
     * @return array
     *
     * @deprecated This API has been deprecated since 1.8.0. Please use `getUsage` instead.
     * @see TablesDB::getUsage
     */
    public function getUsage(string $databaseId, ?UsageRange $range = null): array
    {
        $apiPath = str_replace(
            ['{databaseId}'],
            [$databaseId],
