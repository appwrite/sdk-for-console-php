...
class Sites extends Service
{
     ...
     * @return array
     */
    public function listTemplates(?array $frameworks = null, ?array $useCases = null, ?int $limit = null, ?int $offset = null): array
    {
        $apiPath = str_replace(
            [],
            [],
        ...
        if (!is_null($frameworks)) {
            $apiParams['frameworks'] = $frameworks;
        }
     ...
     * @return array
     */
    public function getUsage(string $siteId, ?UsageRange $range = null): array
    {
        $apiPath = str_replace(
            ['{siteId}'],
            [$siteId],
