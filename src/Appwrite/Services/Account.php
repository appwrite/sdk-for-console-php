...
class Account extends Service
{
     ...
     * @return array
     */
    public function createPushTarget(string $targetId, string $identifier, ?string $providerId = null): array
    {
        $apiPath = str_replace(
            [],
            [],
     ...
     * @return array
     */
    public function updatePushTarget(string $targetId, string $identifier): array
    {
        $apiPath = str_replace(
            ['{targetId}'],
            [$targetId],
