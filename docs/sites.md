...
```http request
GET https://cloud.appwrite.io/v1/sites/templates
```
...
```http request
GET https://cloud.appwrite.io/v1/sites/templates/{templateId}
```
...
```http request
GET https://cloud.appwrite.io/v1/sites/usage
```
...
```http request
GET https://cloud.appwrite.io/v1/sites/{siteId}/usage
```
