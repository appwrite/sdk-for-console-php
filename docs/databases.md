...
```http request
GET https://cloud.appwrite.io/v1/databases/usage
```
...
```http request
GET https://cloud.appwrite.io/v1/databases/{databaseId}/collections/{collectionId}/documents/{documentId}/logs
```
...
```http request
GET https://cloud.appwrite.io/v1/databases/{databaseId}/collections/{collectionId}/logs
```
...
```http request
GET https://cloud.appwrite.io/v1/databases/{databaseId}/collections/{collectionId}/usage
```
...
```http request
GET https://cloud.appwrite.io/v1/databases/{databaseId}/logs
```
...
```http request
GET https://cloud.appwrite.io/v1/databases/{databaseId}/usage
```
