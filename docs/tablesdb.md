...
```http request
GET https://cloud.appwrite.io/v1/tablesdb/usage
```
...
```http request
GET https://cloud.appwrite.io/v1/tablesdb/{databaseId}/tables/{tableId}/logs
```
...
```http request
GET https://cloud.appwrite.io/v1/tablesdb/{databaseId}/tables/{tableId}/rows/{rowId}/logs
```
...
```http request
GET https://cloud.appwrite.io/v1/tablesdb/{databaseId}/tables/{tableId}/usage
```
...
```http request
GET https://cloud.appwrite.io/v1/tablesdb/{databaseId}/usage
```
